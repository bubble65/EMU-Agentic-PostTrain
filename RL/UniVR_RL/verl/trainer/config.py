...
@dataclass
class DataConfig:
    train_files: Any = ""    # str, list[str], or dict for multi-source datasets
    source_sample_counts: Any = "" 
    val_files: Any = ""      # str, list[str], or dict for multi-source datasets
    ...
    enable_cfg: bool = False  # Enable CFG for Emu3 pre-tokenized data
    max_images: Optional[int] = None  # Max images per sample for Emu3
    interleaved_text: bool = False  # Enable interleaved caption-before-image format in answer sequence
