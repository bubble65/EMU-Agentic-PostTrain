...
def build_emu3p5_vllm(
    ...
    **kwargs,
    ...
    model = LLM(
        ...
        # NOTE: on Blackwell B300 (sm_103a) the bundled triton/inductor ptxas
        # (CUDA 12.8) cannot compile sm_103a kernels and crashes startup.
        # Set EMU_ENFORCE_EAGER=1 to skip torch.compile entirely (slower, but
        # runs). When a CUDA 13+ ptxas is available, leave EMU_ENFORCE_EAGER
        # unset and TRITON_PTXAS_PATH pointing at it.
